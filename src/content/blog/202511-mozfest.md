...
The Mozilla Foundation is dedicated to make a better technology future. It's the parent of the Mozilla Corporation, well known for [Firefox browser](https://www.firefox.com/en-US/). The foundation also support a large number of initiatives.

They just launch the Mozilla Foundation Incubator and we are proud to have been selected in the first cohort.
...
- Blow up our mind by listening to amazing talks like [Abeba Birhane](https://en.wikipedia.org/wiki/Abeba_Birhane), [Audrey Tang](https://en.wikipedia.org/wiki/Audrey_Tang), [Chelsea Manning](https://en.wikipedia.org/wiki/Chelsea_Manning) and [many more](https://schedule.mozillafestival.org/schedule)
