<!--
  Draft update for: https://github.com/mlco2/ecologits-api
-->
...
> **Local compute?** See [CodeCarbon](https://github.com/mlco2/codecarbon). **In-process Python?** Use `pip install ecologits` instead.
