<!--
  Draft update for: https://github.com/mlco2/ecologits
  Based on upstream README + cross-links, related tools, community integrations
-->
...
EcoLogits is part of the **[Code Carbon](https://www.helloasso.com/associations/code-carbon)** non-profit — built by volunteers. Chat with us on [Discord](https://discord.gg/CAecQ2zM4n).
